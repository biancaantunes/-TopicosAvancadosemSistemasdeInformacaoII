...
namespace CadastroCarros.Controllers
{
    ...
    {
        private readonly CadastroCarrosContext _context;
        private readonly IWebHostEnvironment _hostEnvironment;

        public CarsController(CadastroCarrosContext context, IWebHostEnvironment hostEnvironment)
        {
            _context = context;
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Color,Year,Model,City,Value,Power,NumberOfDoors,Image")] Car car)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Color,Year,Model,City,Value,Power,NumberOfDoors,Image")] Car car)
        {
            if (id != car.Id)
            {
                return NotFound();
