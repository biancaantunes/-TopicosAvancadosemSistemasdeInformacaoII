...
namespace LivrariaSolution.Controllers
{
    ...
    public class LivrosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Titulo,Editora,Dtlancamento,ImagemLivro")] Livro livro)
        {
        ...
        public async Task<IActionResult> Edit(int id, [Bind("Id,Titulo,Editora,Dtlancamento,ImagemLivro")] Livro livro)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    livroCompare.Titulo = livro.Titulo;
                    livroCompare.Editora = livro.Editora;
