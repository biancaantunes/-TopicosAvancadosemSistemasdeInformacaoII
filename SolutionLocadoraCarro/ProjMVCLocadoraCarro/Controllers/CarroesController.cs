...
namespace ProjMVCLocadoraCarro.Controllers
{
    public class CarroesController : Controller
    {
        ...
        public CarroesController(ProjMVCLocadoraCarroContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Cor,Ano,Modelo,Placa")] Carro carro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Cor,Ano,Modelo,Placa")] Carro carro)
        {
            if (id != carro.Id)
            {
                return NotFound();
