...
namespace ProjLocadoraAPI.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class LocacaosController : ControllerBase
    {
        private readonly ProjLocadoraAPIContext _context;

        public LocacaosController(ProjLocadoraAPIContext context)
        {
            _context = context;
        }
        ...
        {
            return await _context.Locacao.Include(c => c.Carro).ToListAsync();
        ...
        public async Task<ActionResult<Locacao>> GetLocacao(int id)
        {
            ...
            //await _context.Locacao.FindAsync(id);
